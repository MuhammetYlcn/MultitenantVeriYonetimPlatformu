...
// PLATFORM PANELİ teması. Müşteri uygulamasının (client/) temasıyla yapı olarak
// aynıdır ama VURGU RENGİ kasıtlı olarak farklıdır: işletmeci hangi yüzeyde
// olduğunu bir bakışta bilmeli. Müşteri uygulaması menekşe/turkuaz, platform
// paneli amber/gök mavisi — "burada tüm firmalar üzerinde işlem yapıyorum"
// uyarısı renkten okunuyor.
//
// Not: iki proje ayrı derlendiği için bu dosya bilinçli bir kopyadır. Paylaşılan
// bir Dart paketi kurmak iki build hattını da karmaşıklaştırırdı; panel küçük
// olduğu için tek dosyalık tekrar daha ucuz.
//
// Uygulama bilinçli olarak TEK temalı: koyu.

/// Palet. Zemin → kart → kenar sırasıyla açılan üç koyu ton, üstünde iki canlı vurgu.
class AppColors {
  // Ana vurgu: amber — "yetkili/işletmeci alanı" sinyali.
  static const brand = Color(0xFFF59E0B); // amber
  // İkincil vurgu.
  static const accent = Color(0xFF38BDF8); // gök mavisi

  static const danger = Color(0xFFFF6369);
  static const warning = Color(0xFFF5A524);

  // Zemin de müşteri uygulamasından bir tık daha nötr/koyu: iki yüzey yan yana
  // açıkken karışmasın.
  static const bg = Color(0xFF12130F); // sayfa zemini (kartların arkası)
  static const surface = Color(0xFF1B1D18); // kart, sol menü, üst çubuk
  static const surfaceAlt = Color(0xFF262922); // tablo başlığı, giriş alanı dolgusu
  static const border = Color(0xFF343830); // ince ayraçlar ve kart kenarları
